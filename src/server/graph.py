...
from components.nodes import tool_node, search_node, route_scraping, single_scraper, writer_node, critic_node, extract_draft_node, should_use_tool, should_stop_looping
...
graph.add_conditional_edges("critic", should_stop_looping)
